...
presence_classifier = load(os.path.join(os.getcwd(), "urgency_model.pkl"))
presence_vect = load(os.path.join(os.getcwd(), "vector.pkl"))
category_classifier = load(os.path.join(os.getcwd(), "category_classifier.joblib"))
category_vect = load(os.path.join(os.getcwd(), "category_vectorizer.joblib"))
pipeline = pickle.load(open(os.path.join(os.getcwd(), "logistic_regression_model.pkl"), 'rb'))
tfd = pickle.load(open(os.path.join(os.getcwd(), "reviewkatldf.pkl"), 'rb'))
tandc_model = pickle.load(open(os.path.join(os.getcwd(), "tandc.pkl"), 'rb'))
tandc_vector_form = pickle.load(open(os.path.join(os.getcwd(), "tandcvector.pkl"), 'rb'))
...
def next_page_link(url):
    ...
    # Check if pages is None
    if pages is None:
        return []  # Return an empty list if no navigation element is found
    
    next_page = [a.get('href') for a in pages.find_all('a')]  # Ensure to find all 'a' tags
    return next_page
...
def authentic():
    ...
    # make_request_with_retry(url)
     filepath = os.path.join(os.getcwd(), "example.csv")
